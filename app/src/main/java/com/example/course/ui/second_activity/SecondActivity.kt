...
import com.example.course.core.model.CommentAdapter
import com.example.course.core.model.body.Post
import com.example.course.core.model.utilis.CustomeAdapter
import com.example.course.databinding.ActivitySecondBinding
import com.example.course.ui.login.MainLoginActivity
...
class SecondActivity : AppCompatActivity(), MyCustomClickListener {
    ...
    lateinit var postAdapter: CustomeAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = com.example.course.ui.second_activity.SecondViewModel()
        viewModel.postsInformations.observe(this){
            if (it.isSuccessful) {
                val posts = it.body()
                if (posts != null) {
                    postAdapter = CustomeAdapter(posts, this@SecondActivity)
